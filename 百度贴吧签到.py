...
class tieba:
    # bduss
    bduss = 'lNWDVieGZoN3R3bFZOeXFnVUg0V1lZcXFMU1dXY2JLSXJIMWxZZjNROWZXaXRkSVFBQUFBJCQAAAAAAAAAAAEAAABXJIABQXBwbGUyODAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAF~NA11fzQNddU'
    # 填入自己的百度id
    myid = 'Apple280'
